               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维修员姓名" prop="weixiuyuanName">
                       <el-input v-model="ruleForm.weixiuyuanName"
                                 placeholder="维修员姓名" clearable  :readonly="ro.weixiuyuanName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维修员手机号" prop="weixiuyuanPhone">
                       <el-input v-model="ruleForm.weixiuyuanPhone"
                                 placeholder="维修员手机号" clearable  :readonly="ro.weixiuyuanPhone"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="维修员身份证号" prop="weixiuyuanIdNumber">
                       <el-input v-model="ruleForm.weixiuyuanIdNumber"
                                 placeholder="维修员身份证号" clearable  :readonly="ro.weixiuyuanIdNumber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="邮箱" prop="weixiuyuanEmail">
                       <el-input v-model="ruleForm.weixiuyuanEmail"
                                 placeholder="邮箱" clearable  :readonly="ro.weixiuyuanEmail"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  class="input" label="入职日期" prop="weixiuyuanTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.weixiuyuanTime"
                                type="datetime"
                                placeholder="入职日期"
                                :disabled="ro.weixiuyuanTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.weixiuyuanTime" label="入职日期" prop="weixiuyuanTime">
                            <span v-html="ruleForm.weixiuyuanTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    weixiuyuanName: false,
                    weixiuyuanPhoto: false,
                    weixiuyuanPhone: false,
                    weixiuyuanIdNumber: false,
                    weixiuyuanEmail: false,
                    sexTypes: false,
                    weixiuyuanDelete: false,
                    weixiuyuanTime: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                ...
                rules: {
                   ...
                   weixiuyuanName: [
                              { required: true, message: '维修员姓名不能为空', trigger: 'blur' },
                          ],
                   weixiuyuanPhoto: [
                              { required: true, message: '头像不能为空', trigger: 'blur' },
                          ],
                   weixiuyuanPhone: [
                              {  required: true, message: '维修员手机号不能为空', trigger: 'blur' },
                   ...
                   weixiuyuanIdNumber: [
                              { required: true, message: '维修员身份证号不能为空', trigger: 'blur' },
