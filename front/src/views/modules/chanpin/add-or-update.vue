        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="产品编号" prop="chanpinUuidUnmber">
                       <el-input v-model="ruleForm.chanpinUuidUnmber"
                                 placeholder="产品编号" clearable  :readonly="ro.chanpinUuidUnmber"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="产品详情" prop="chanpinContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.chanpinContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.chanpinContent" label="产品详情" prop="chanpinContent">
                            <span v-html="ruleForm.chanpinContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                userId:"",//当前登录人的id
                ro:{
                    chanpinUuidUnmber: false,
                    chanpinName: false,
                    chanpinTypes: false,
                    shangxiaTypes: false,
                    chanpinContent: false,
                },
                ruleForm: {
                    chanpinUuidUnmber: '',
                    chanpinName: '',
